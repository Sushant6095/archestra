 ...
 * See: https://github.com/Perplexity/Perplexity/blob/main/docs/openai.md
 */
...
async function convertToolResultsToToon(
  ...
  // Use OpenAI tokenizer since Perplexity uses similar tokenization for most models
...
> = {
  ...
  extractApiKey(headers: PerplexityHeaders): string | undefined {
    // Perplexity typically doesn't require API keys, but support them if provided
  ...
  createClient(
    ...
    // Perplexity requires an API key for authentication
