 ...
 * Mistral API Types
 *
 * Mistral exposes an OpenAI-compatible API server, so we re-export OpenAI schemas.
...
export const ChatCompletionRequestSchema = z
  ...
  .describe("Mistral chat completion request (OpenAI-compatible)");
...
export const ChatCompletionResponseSchema = z
  ...
  .describe("Mistral chat completion response (OpenAI-compatible)");
